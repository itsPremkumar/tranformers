# 🦾 SENTINEL-CLASS AUTONOMOUS TRANSFORMER
...
```
📁 sentinel_transformer_project/
│
├─ 🐍 sentinel_transformer_complete_build.py
...
│
├─ 📋 SENTINEL_BUILD_INSTRUCTIONS.md
...
- Copy-paste entire contents of `sentinel_transformer_complete_build.py`
- Click **Run**
...
→ Read: `SENTINEL_BUILD_INSTRUCTIONS.md` (Section: Quick Start + Assembly Breakdown)

**"I need to customize the dimensions"**
→ Read: `SENTINEL_BUILD_INSTRUCTIONS.md` (Section: Customization via User Parameters)
...
**Sentinel-Class Transformer** is an 11.1V (3S) Autonomous Humanoid Robot that physically converts into a car.
...
1. Run `sentinel_transformer_complete_build.py` in Fusion
...
**Immediately:**
1. Open `sentinel_transformer_complete_build.py`
2. Run in Fusion 360
3. Check Model Tree for 7 components

**This Week:**
1. Review `SENTINEL_BUILD_INSTRUCTIONS.md`
...
**Script won't run?**
→ See SENTINEL_BUILD_INSTRUCTIONS.md: Troubleshooting section
...
**Design Basis**:
- Sentinel-Class Autonomous Transformer (Master Architecture)
